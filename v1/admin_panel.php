...
// Joining with users to get contact info
$sql_new = "SELECT b.*, u.phone_number, u.email 
            FROM bookings b 
            JOIN users u ON b.user_id = u.id 
            WHERE b.status = 'awaiting_quote' 
            ORDER BY b.created_at ASC";
$stmt_new = $pdo->query($sql_new);
$new_requests = $stmt_new->fetchAll();

// Fetch Active Jobs (confirmed)
$sql_active = "SELECT b.*, u.phone_number, u.email 
               FROM bookings b 
               JOIN users u ON b.user_id = u.id 
...
<body>
    <div class="container" style="max-width: 1000px;">
        ...
        <h3>New Requests (Awaiting Quote)</h3>
                    ...
                    <?php foreach ($new_requests as $req): ?>
                        <tr>
                            ...
                            <td>
                                ...
                                <strong>Phone:</strong> <?php echo htmlspecialchars($req['phone_number']); ?>
                            </td>
        ...
        <h3 style="margin-top: 40px;">Active Jobs (Confirmed)</h3>
                    ...
                    <?php foreach ($active_jobs as $job): ?>
                        <tr>
                            ...
                            <td>
                                ...
                                <strong>Phone:</strong> <?php echo htmlspecialchars($job['phone_number']); ?>
                            </td>
                            ...
                            <td>
                                <form method="post" style="display:flex; gap:5px;">
                                    ...
                                    <input type="number" name="actual_bill" step="0.01" placeholder="Final Bill ($)" required style="width: 100px; padding: 5px;">
